...
test('should return the total number of night shift hours', () => {
  const inputTestData = [
    {
      "id": 1,
      "from": "2017-10-23T08:00:00+11:00",
...
test('should return the total number of night shift hours as 0 if start and end time do not fall in the desired range', () => {
  const inputTestData = [
    {
      "id": 1,
...
test('should return "isValid: true" if total number of hours for each shift is more than or equal to an hour', () => {
  const inputTestDataForValidShiftHours = [ { id: 1,
    from: '2017-10-23T08:00:00+11:00',
    to: '2017-10-23T11:00:00+11:00',
    totalDayShiftHours: 3,
    totalNightShiftHours: 0 },
  ...
  { id: 9,
    ...
    totalDayShiftHours: 0,
    totalNightShiftHours: 0 } ];
  const expectedTestDataWithValidShiftHours = [ { id: 1,
    from: '2017-10-23T08:00:00+11:00',
    to: '2017-10-23T11:00:00+11:00',
    totalDayShiftHours: 3,
    totalNightShiftHours: 0,
